...
import {
  INFLUENCER_COLLAB_NETWORKING_TYPES,
  INFLUENCER_COLLAB_TYPES,
} from "@/shared-constants/preferences/influencer-collab-types";
...
const InfluencerApplyScreen = () => {
    ...
    try {
      if (
        category == "networking"
          ? !reason
          : !reason ||
            (!!exampleLink && !isValidLink(exampleLink)) ||
            (collabMode === "paid" && (!budgetMin || !budgetMax)) ||
            collabType.length === 0
      )
        return;
  ...
  return (
    <>
      <ScreenHeader
        title={
          category == "networking" ? "Invite Influencer" : "Invite Influencer"
        }
        rightAction={true}
        // rightActionButton={
        //   <TouchableOpacity
        ...
        //     <Text
        //       variant="titleMedium"
        //       style={{ paddingHorizontal: 16, color: Colors(theme).text }}
        //     >
        //       Submit
        //     </Text>
        //   </TouchableOpacity>
      ...
      >
        {category == "networking" ? (
          <ScrollView contentContainerStyle={{ padding: 20 }}>
            <Text
              variant="titleMedium"
              style={{ marginBottom: 8, color: Colors(theme).text }}
            >
              Tell us why you want to Connect?
            </Text>
            <TextInput
              autoFocus
            ...
            <Text
              variant="titleMedium"
              style={{ marginTop: 0, color: Colors(theme).text }}
            >
            ...
            >
              <Select
                items={INFLUENCER_COLLAB_NETWORKING_TYPES.map((v) => ({
                  label: v,
                  value: v,
                }))}
                selectItemIcon={true}
            ...
            {!onSameLevel && (
              ...
              >
                ...
                <Text style={{ color: "#856404" }}>
                  Love the networking spirit! But to make real connections, try
                  the “Co-create” route—most influencers respond better when
                  there’s a fun collab idea in the mix.
                </Text>
              </View>
            )}
            ...
            <Text
              ...
              onPress={() => {
                router.replace(
                  `/influencer-invite/${influencerId}?category=co-create`
                );
              }}
            >
              Have a content creation idea? Click here to connect for
          ...
          <ScrollView contentContainerStyle={{ padding: 20 }}>
            <Text
              ...
              style={{ marginBottom: 8, color: Colors(theme).text }}
            >
              Tell us why you want to collab?
            </Text>
            <TextInput
              autoFocus
            ...
            <Text
              ...
              style={{ marginTop: 0, color: Colors(theme).text }}
            >
              What kind of collab are you thinking?
            </Text>
            <View
              style={{
                flexDirection: "row",
            ...
            >
              <Select
                items={INFLUENCER_COLLAB_TYPES.map((v) => ({
                  label: v,
                  value: v,
                }))}
                selectItemIcon={true}
            ...
            <Text
              variant="titleMedium"
              style={{ marginTop: 20, color: Colors(theme).text }}
            >
              Are you willing to pay for Collab?
            </Text>
            <SegmentedButtons
              value={collabMode}
              ...
              buttons={[
                {
                  ...
                  style: {
                    backgroundColor:
                      collabMode === "free" ? Colors(theme).primary : undefined,
                  },
                  labelStyle: {
                    color:
                      collabMode === "free"
                ...
                },
                {
                  ...
                  style: {
                    backgroundColor:
                      collabMode === "paid" ? Colors(theme).primary : undefined,
                  },
                  labelStyle: {
                    color:
                      collabMode === "paid"
            ...
            >
              Most influencers don’t work for free—adding a budget makes your
              offer more compelling and shows you’re serious.
            </Text>
            ...
            <View style={{ marginBottom: 30, marginTop: 50 }}>
              ...
              >
                Filling these out increases your chances of getting your invite
                accepted
              </Text>
            </View>
            ...
            <HelperText
              type="error"
              visible={!!exampleLink && !isValidLink(exampleLink)}
            >
            ...
            <Text
              ...
              style={{ marginTop: 0, color: Colors(theme).text }}
            >
              Which platform are you planning this collab on?
            </Text>
            <View
              style={{
                flexDirection: "row",
